...
def file_exist(path: Path, metadata: list) -> bool:
...
def main():
    ...
    for file in DOCS_DIR.rglob("*"):
        ...
        if file_exist(path=file, metadata=metadata):
            continue
...
if __name__ == "__main__":
    ...
    try:
        ...
        logging.exception("Index update failed with error")
    finally:
